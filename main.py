...
def logger(old_function):
    ...
    def new_function(*args, **kwargs):
        ...
        key = f'Функция {old_function.__name__} вызвана в {start} с параметрами {args} и {kwargs} '
        result = old_function(*args, **kwargs)
        key += f' и результат функции {result}'
        content.append(key)
...
#3Применить написанный логгер к приложению из любого предыдущего д/з.

from tools import test_3
